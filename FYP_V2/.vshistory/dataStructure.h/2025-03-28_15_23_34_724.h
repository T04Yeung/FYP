...
public:
	...
	// Replace std::tie with device-compatible logic
	__host__ __device__ bool operator<(const Edge& other) const {
		return weight < other.weight; // Simplified for device compatibility
	}
};
