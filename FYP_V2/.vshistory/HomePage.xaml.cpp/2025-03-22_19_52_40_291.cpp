...
#define graph SharedState::getInstance().graph
#define currentNodes SharedState::getInstance().currentNodes
#define currentEdges SharedState::getInstance().currentEdges
