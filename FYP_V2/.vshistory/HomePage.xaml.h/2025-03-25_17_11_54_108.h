    ...
    struct HomePage : HomePageT<HomePage>
    {
        HomePage()
        {
            ...
            if (SharedData::getInstance().totalSnapshots > 1) {
				GraphBtnPanel().Visibility(winrt::Microsoft::UI::Xaml::Visibility::Visible);
            }
        }
        ...
        void PrevBtn_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e);
        ...
        void algorithmBox_SelectionChanged(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::Controls::SelectionChangedEventArgs const& e);
    };
}
