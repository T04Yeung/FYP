...
namespace winrt::FYP_V2::implementation
{
    winrt::FYP_V2::RecordViewModel RecordViewModel::Create(
        ...
        double timeSpend,
        winrt::Windows::Foundation::Collections::IVectorView<winrt::hstring> nodeList,
        ...
        instance->nodeList = winrt::single_threaded_vector<winrt::hstring>(std::move(nodeList)).GetView();
    ...
    winrt::Windows::Foundation::Collections::IVectorView<winrt::hstring> RecordViewModel::NodeList() {
        return nodeList;
    }
