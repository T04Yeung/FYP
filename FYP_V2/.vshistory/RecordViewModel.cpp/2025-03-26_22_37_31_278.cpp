...
namespace winrt::FYP_V2::implementation
{
    winrt::FYP_V2::RecordViewModel RecordViewModel::Create(
        ...
        double timeSpend,
        winrt::Windows::Foundation::Collections::IVector<winrt::hstring> nodeList,
    ...
    winrt::Windows::Foundation::Collections::IVector<winrt::hstring> RecordViewModel::NodeList() {
        return nodeList;
    }
    ...
    winrt::param::vector<winrt::hstring> ConvertNodeListToNameVector(std::vector<Node>& nodeList) {
        std::vector<winrt::hstring> result;
        for (auto& node : nodeList) {
            result.push_back(winrt::to_hstring(node.name));
        }
        return winrt::single_threaded_vector<winrt::hstring>(std::move(result));
    }
}
