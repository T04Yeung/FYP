...
enum algorithmType {
    ParallelDijkstra, _2DPartitioningBFS, kosarajuAlgorithm
};
...
void winrt::FYP_V2::implementation::RecordPage::ExportBtn_Click(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
{
    ...
    if (algorithmIdx == algorithmType::ParallelDijkstra) {
    ...
    else if (algorithmIdx == algorithmType::kosarajuAlgorithm) {
        auto er = KosarajuExcel();
        er.setRecord(record);
        er.exportResult();
    }
