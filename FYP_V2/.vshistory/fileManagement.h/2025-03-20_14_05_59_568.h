...
class fileFunctions {
private:
	std::string dataRootDirectoryStr = "data";
	std::vector<std::string> subDirectoryList = {
		"\\record"
	};
public:
	std::string getDataRootDirectoryStr() { return dataRootDirectoryStr; }
	std::vector<std::string> getSubDirectoryList() { return subDirectoryList; }
